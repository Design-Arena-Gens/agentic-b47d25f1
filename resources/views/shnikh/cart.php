    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <?php if (!$cart): ?>
            <div class="mt-8 border border-dashed border-slate-200 rounded-2xl p-10 text-center">
                <p class="text-slate-500">Your cart is empty. Explore <a class="text-emerald-600 font-semibold" href="/shnikh/products">products</a> to add items.</p>
            </div>
        <?php else: ?>
            <form action="/shnikh/cart/update" method="post" class="mt-8 space-y-6">
                    ...
                    <div class="flex items-center gap-6 border border-slate-200 rounded-2xl p-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 flex items-center gap-3">
                                ...
                                <button type="submit" formaction="/shnikh/cart/remove/<?= $item['slug'] ?>" class="text-sm text-slate-500 hover:text-red-500 font-semibold">Remove</button>
                            </div>
                        </div>
                ...
                <div class="flex justify-end">
                    <button class="inline-flex items-center px-5 py-3 border border-emerald-500 text-emerald-600 rounded-full font-semibold hover:bg-emerald-50 transition">Update Cart</button>
                </div>
            </form>

            <div class="mt-10 border border-slate-200 rounded-2xl p-6 bg-slate-50">
                ...
                <a href="/shnikh/checkout" class="mt-6 brand-button inline-flex items-center justify-center px-5 py-3 rounded-full font-semibold">Proceed to Checkout</a>
            </div>
        <?php endif; ?>
    </div>
</section>
