...
<section class="bg-white py-16">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="mt-10 grid lg:grid-cols-5 gap-10">
            <form class="lg:col-span-3 space-y-5 border border-slate-200 rounded-2xl p-6" action="/shnikh/checkout" method="post">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" class="mt-1 w-full px-4 py-2 border border-slate-200 rounded-lg" placeholder="Cultivar specifications, delivery instructions..."></textarea>
                </div>
                <div>
                    ...
                    <div class="mt-3 space-y-3">
                        <label class="flex items-start space-x-3 border border-slate-200 rounded-xl p-4">
                            ...
                            <span>
                                ...
                                <p class="text-xs text-slate-500 mt-1">Available across major Indian cities. Logistics partner collects payment.</p>
                            </span>
                        </label>
                        <label class="flex items-start space-x-3 border border-slate-200 rounded-xl p-4">
                            ...
                            <span>
                                ...
                                <p class="text-xs text-slate-500 mt-1">Secure UPI, cards, and netbanking. Redirect to Razorpay checkout.</p>
                            </span>
                        </label>
                    </div>
                </div>
            ...
            <aside class="lg:col-span-2 border border-slate-200 rounded-2xl p-6 bg-slate-50">
